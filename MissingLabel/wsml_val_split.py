...
# load val data
X_path = '/home-mscluster/oenabor/home/pseudo/exp1/datasets/AU_data/X_val.npy'
X = np.load(X_path, allow_pickle=True)

y_path = '/home-mscluster/oenabor/home/pseudo/exp1/datasets/AU_data/y_val.npy'
# load true labels
y= np.load(y_path, allow_pickle=True)
# split data
X_val, X_test, y_val, y_test = train_test_split(X, y, test_size=0.5, random_state=1)
# save predictions into numpy format
np.save('/home-mscluster/oenabor/home/wsml/data/X_val_91222.npy',X_val)
np.save('/home-mscluster/oenabor/home/wsml/data/X_test_91222.npy',X_test)
np.save('/home-mscluster/oenabor/home/wsml/data/y_val_91222.npy',y_val)
np.save('/home-mscluster/oenabor/home/wsml/data/y_test_91222.npy',y_test)
