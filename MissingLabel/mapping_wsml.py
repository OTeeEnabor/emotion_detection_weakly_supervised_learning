...
# LOAD THE DATASET
# create dataset path
data_path = '/home-mscluster/oenabor/home/au_models/data/emotionAUmappings2'#'/home-mscluster/oenabor/home/exp1/data/AU_img_data_norm.csv'
# create dataframe
...
#   path_true = f'/home-mscluster/oenabor/home/wsml/exp1/saved_models/00033-test-train-13122022/' \
...
"""
for consistency - in mapping aus
"""
for emotion in emotions_list:
  # read csv
  emotion_df = pd.read_csv(f"{data_path}/{emotion}_true.csv")
  path_list = emotion_df['Path'].tolist()
  # create X input forthe model
  X = create_dataset(emotion_df)
  # feed input into model and make predictions
  y_pred = model.predict(X)
  # threshold the results
  y_pred = label_binarizer(y_pred, 0.5)
  # create dataframe
  ...
  pred_df['Path'] = path_list
  # save to csv
  path = f'/home-mscluster/oenabor/home/wsml/exp1/saved_models/00061-test-train-30122022/emotionAUmappings/{emotion}_pred.csv'
  pred_df.to_csv(path)
  print(f'{emotion} csv saved')
