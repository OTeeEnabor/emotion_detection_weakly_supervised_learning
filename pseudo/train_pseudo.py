...
def supervised_train(X_train,Y_train,X_val,Y_val,P,run_dir):
  ...
  train_df.to_csv(f'{run_dir}/train_info_labelled_training.csv')
...
# load val
X_val_path = '/home-mscluster/oenabor/home/pseudo/exp1/datasets/AU_data/X_val_pseudo.npy'
X_val = np.load(X_val_path,allow_pickle=True)
y_val_path = '/home-mscluster/oenabor/home/pseudo/exp1/datasets/AU_data/y_val_pseudo.npy'
...
supervised_train(X_train,y_train,X_val,y_val,P,run_dir)
