...
###############################################
loss_fun = tensorflow.keras.losses.BinaryCrossentropy(
    #     from_logits = True,
    reduction="none"
  )
  # compute assumed negative loss binary cross entropy matrix
...
X_test_path = '/home-mscluster/oenabor/home/pseudo/exp1/datasets/AU_data/X_test_pseudo.npy'
y_test_path = '/home-mscluster/oenabor/home/pseudo/exp1/datasets/AU_data/y_test_pseudo.npy'
# load test path
...
model_path = '/home-mscluster/oenabor/home/pseudo/exp1/saved_models/au_models/00074-test-train-26022023/model-01-0.36.hdf5'
...
pred_test_final = tensorflow.cast(pred_test_final, dtype=tensorflow.float32)
test_loss = loss_fun(y_test,pred_test_final)
...
np.save('/home-mscluster/oenabor/home/pseudo/exp1/saved_models/au_models/00074-test-train-26022023/pred_test.npy',pred_test_final)
