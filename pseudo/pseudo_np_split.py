...
##########################################################################
# read in datasets
# train_df = pd.read_csv('/home-mscluster/oenabor/home/pseudo/exp1/datasets/train.csv')
# val_df = pd.read_csv('/home-mscluster/oenabor/home/pseudo/exp1/datasets/val.csv')
# unlabeled_df = pd.read_csv('/home-mscluster/oenabor/home/pseudo/exp1/datasets/unlabeled.csv')
train_unlabeled_df = pd.read_csv('/home-mscluster/oenabor/home/pseudo/exp1/datasets/train_unlabelled_combined_er_19022023.csv')
# create numpy representation of datasets
# X_train, y_train = create_dataset(train_df,'emotion')
# X_val, y_val = create_dataset(val_df,'emotion')
# X_unlabeled, y_unlabeled = create_dataset(unlabeled_df,'emotion')
X_train_unlabeled, y_train_unlabeled = create_dataset(train_unlabeled_df,'emotion')

#save np
path = '/home-mscluster/oenabor/home/pseudo/exp1/datasets/ER_data'
np.save(f'{path}/X_train_unlabeled', X_train_unlabeled)
np.save(f'{path}/y_train_unlabeled', y_train_unlabeled)
