...
outdir = '/home-mscluster/oenabor/home/au_models/saved_models/'
...
X_path = '/home-mscluster/oenabor/home/au_models/data/train_split/X_train.npy'
y_path = '/home-mscluster/oenabor/home/au_models/data/train_split/y_train.npy'
...
# # load the ER Model
ER_MODEL_PATH = '/home-mscluster/oenabor/home/er_models/saved_models/00002-test-train-21102022/model-41-0.05.hdf5'
ER_OPTIMIZER_PATH = '/home-mscluster/oenabor/home/er_models/saved_models/00002-test-train-21102022/model-41-0.05.pkl'
model_er = load_model_data(ER_MODEL_PATH, ER_OPTIMIZER_PATH)
#
# train the AU model
with Logger(os.path.join(run_dir, 'log.txt')):
  model = create_AU_model(model_er)
  train_AU_model(X,y,model)

print('Training the AU model has finished.')